        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap gap-2 mb-8">
            ...
            >
              ...
              Products
              <span className="px-1.5 py-0.5 bg-dark-900 rounded-full text-xs">{inquiries.length}</span>
            </button>
            <button
            ...
            >
              ...
              Services
              <span className="px-1.5 py-0.5 bg-dark-900 rounded-full text-xs">{serviceInquiries.length}</span>
            </button>
            <button
            ...
            >
              ...
              Assessments
              <span className="px-1.5 py-0.5 bg-dark-900 rounded-full text-xs">{assessments.length}</span>
            </button>
            <button
            ...
            >
              ...
              Installs
              <span className="px-1.5 py-0.5 bg-dark-900 rounded-full text-xs">{registrations.length}</span>
            </button>
            <button
            ...
            >
              <FiPackage className="w-4 h-4" />
              MOS Accounts
              <span className="px-1.5 py-0.5 bg-dark-900 rounded-full text-xs">{mosAccounts.length}</span>
            </button>
          </div>
